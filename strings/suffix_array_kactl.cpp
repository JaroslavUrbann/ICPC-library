...
// lexicographically i-th suffix starts at sa[i], sa[0]=n
// suffixes at sa[i-1] and sa[i] have a common prefix of length lcp[i], lcp[0|1] is garbage
struct SuffixArray{
	vector<int>sa,lcp;
	SuffixArray(string&s,int lim=256){ // use basic_string<int>, can't have zeroes
